...
def create_dataset(data_config: _config.DataConfig, model_config: _model.BaseModelConfig) -> Dataset:
    ...
    dataset_dir=os.path.join(os.getenv('DEXMG_DATA_DIR'),dataset_name)

    dataset_meta = lerobot_dataset.LeRobotDatasetMetadata(repo_id, root=dataset_dir, local_files_only=True)
